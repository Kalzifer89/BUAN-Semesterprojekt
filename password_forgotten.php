...
<?php include "core/password_send.php" ?>
    ...
    <section class="clean-block clean-form dark">
        <div class="container">
            <div class="block-heading">
                ...
                <p>Sie haben ihr Passwort vergessen? Kein Problem, geben sie hier einfach die Antwort auf ihre Geheimfrage ein wir schicken ihnen ein neues Passwort.</p>
            </div>
        ...
        <button class="btn btn-primary btn-block" type="submit">Absenden</button></form>
        </div>
    </section>
</main>
