            ...
            <div class="content">
                <div class="row no-gutters">
                        ...
                        <div class="items">
                            <div class="product">
                                <div class="row justify-content-center align-items-center">
                                    ...
                                    <div class="col-6 col-md-2 quantity"><label class="d-none d-md-block" for="quantity">Anzahl</label><input type="number" id="number" class="form-control quantity-input" value="1"></div>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="summary">
                            <h3>Gesamt:</h3>
                            <h4><span class="text">Zwischensumme</span><span class="price">$360</span></h4>
                            <h4><span class="text">Nachlass</span><span class="price">$0</span></h4>
                            <h4><span class="text">Versand</span><span class="price">$0</span></h4>
                            <h4><span class="text">Total</span><span class="price">$360</span></h4><button class="btn btn-primary btn-block btn-lg" type="button">Bezahlen</button></div>
                    </div>
                </div>
            </div>
        </div>
